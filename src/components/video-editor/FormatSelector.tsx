				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#FF6F00]/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
								? "bg-[#FF6F00]/10 border-[#FF6F00]/50 text-[#FF6F00] dark:text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#FF6F00]/20 text-[#FF6F00]" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#FF6F00]" />
						)}
					</button>
				);
			})}
