...
const CURSOR_SVG_DROP_SHADOW_FILTER = "drop-shadow(0px 3px 5px rgba(0, 0, 0, 0.48))";
const CURSOR_SHADOW_COLOR = 0x000000;
const CURSOR_SHADOW_ALPHA = 0.46;
const CURSOR_SHADOW_OFFSET_X = 0;
const CURSOR_SHADOW_OFFSET_Y = 3;
const CURSOR_SHADOW_BLUR = 5;
const CURSOR_SHADOW_PADDING = 18;
