	...
	return (
		...
		>
						...
						return (
							<button
								...
								className={cn(
									...
									isActive
										? "border-[#FF6F00]/50 text-[#FF6F00] dark:text-white"
							...
							>
								{isActive ? (
									<motion.span
										...
										className="absolute inset-0 rounded-xl bg-[#FF6F00]/10"
			...
			{exportFormat === "mp4" ? (
				<LayoutGroup id="header-export-quality-toggle">
					...
					{!isLegacyModel && nvidiaCudaExportAvailable ? (
						<div className="mb-3 flex min-h-12 items-center justify-between gap-3 rounded-lg border border-[#FF6F00]/20 bg-[#FF6F00]/5 px-3 py-2">
							<div className="min-w-0">
								<div className="flex items-center gap-1.5">
									<span className="text-[11px] font-semibold text-foreground">
										{tSettings("export.nvidiaCuda.title", "NVIDIA CUDA")}
									</span>
									<span className="rounded bg-[#FF6F00]/10 px-1.5 py-0.5 text-[9px] font-semibold uppercase text-[#FF6F00]">
							...
							<Switch
								...
								className="shrink-0 scale-75 data-[state=checked]:bg-[#FF6F00]"
							/>
						</div>
					) : null}
					...
					<div className="flex items-center justify-between px-1">
						...
						<div className="flex items-center gap-2">
							...
							<Switch
								...
								className="scale-75 data-[state=checked]:bg-[#FF6F00]"
							/>
						</div>
					</div>
				</div>
			...
			<Button
				...
				size="lg"
				onClick={onExport}
				className="h-11 w-full gap-2 rounded-lg bg-[#FF6F00] text-sm font-semibold text-white transition-colors duration-200 hover:bg-[#FF6F00]/90"
			>
